...
function main() {
    ...
    $("head").append(`<script type="text/javascript" src="https://livejs.com/live.js"></script><meta name="theme-color" content="#4F46E5"><style>::selection{background-color: #4F46E5;}</styl>`);
